"""
Created on Fri Oct 13 14:54:31 2023
...
from cyclistsocialforce.vizualisation import BicycleDrawing
...
def scenario_passing(fig, axes, unstable):
    ...
    if unstable:
        bike1 = InvPendulumBicycle((0, 0.1, 0 , 3, 0, 0), 
                                userId='a', 
                                saveForces=True)
        bike2 = InvPendulumBicycle((30, -0.1, np.pi, 5, 0, 0), 
                                userId='b', 
                                saveForces=True)
    else:
        bike1 = TwoDBicycle((0, 0.1, 0 , 3, 0), 
                              userId='a', 
                              saveForces=True)
        bike2 = TwoDBicycle((30, -0.1, np.pi, 5, 0), 
                              userId='b', 
                              saveForces=True)
    ...
    # Run the simulation
    tsim = (2.5,7)
    run(intersection, fig, fig_bg, tsim, (unstable,(1,)))
...
def scenario_overtaking(fig,axes, unstable):
    ...
    if unstable:
        bike1 = InvPendulumBicycle((-5, .1, 0, 3, 0, 0), 
                                userId='a', 
                                saveForces=True)
        bike1.params.v_desired_default = 3.
        bike2 = InvPendulumBicycle((-20, 0, 0, 6, 0, 0), 
                                userId='b', 
                                saveForces=True)
        bike2.params.v_desired_default = 6.
    else:
        bike1 = TwoDBicycle((-5, 0.1, 0, 3, 0), 
                              userId='a', 
                              saveForces=True)
        bike1.params.v_desired_default = 3.
        bike2 = TwoDBicycle((-20, 0, 0, 6, 0), 
                              userId='b', 
                              saveForces=True)
        bike2.params.v_desired_default = 6.
...
def scenario_crossing(fig,axes, unstable):
    ...
    if unstable:
        ...
        bike1 = TwoDBicycle((-23+17, 0, 0, 5, 0), 
                              userId='a', 
                              saveForces=True)
        bike1.params.v_desired_default = 4.5
        bike2 = TwoDBicycle((0+15, -20, np.pi/2, 5, 0), 
                              userId='b', 
                              saveForces=True)
        bike2.params.v_desired_default = 5.
        bike3 = TwoDBicycle((-2+15, -20, np.pi/2, 5, 0), 
                              userId='c', 
                              saveForces=True)
        bike3.params.v_desired_default = 5.
    ...
    run(intersection, fig, fig_bg, tsim, (unstable,(1,2)))
...
def scenario_stepresponse(save=False):
    ...
    tsim = (4.,20.,1.)    
    bike1 = InvPendulumBicycle((1, 3, 0 , 5, 0, 0), userId='b1', saveForces=True)
...
def scenario_parcours(fig, axes, unstable):
    ...
    if unstable:
        bike1 = InvPendulumBicycle((1-5, 0, 0 , 6, 0, 0), 
                                userId='a', saveForces=True)
    else:
        bike1 = TwoDBicycle((1-5, 0, 0 , 6, 0), 
                              userId='a', saveForces=True)
    ...
    # Run the simulation
    tsim = (2.5,7)
    run(intersection, fig, fig_bg, tsim)
...
def run(intersection, fig, fig_bg, tsim, bikes_for_forcefield_plot=[]):
    ...
    if len(bikes_for_forcefield_plot) > 0 and \
       len(bikes_for_forcefield_plot[1]) > 0 and \
       bikes_for_forcefield_plot[0]:
        bikes = [intersection.vehicles[i] for i in bikes_for_forcefield_plot[1]]
        ...
        intersection.ax.contourf(X,Y,np.sqrt(Fx**2+Fy**2), cmap='RdPu', levels=15, animate=False)
